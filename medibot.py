...
# Load .env from project root and from data/ so GROQ_API_KEY is available
...
def main():
    ...
    if prompt:
        ...
        try:
            ...
            if not groq_key:
                st.error("GROQ_API_KEY is not set. Add it to data/.env or a .env file in the project root.")
                return
